...
//		$textoFecha="11-07-2019";
	...
	function ponerCuadroPersonas()
	{
		...
		$porcentajeTrabajo=$this->arrDatos['tema_Trabajo_digno_e_inclusion']*80/100;
		$porcentajeGenero=$this->arrDatos['tema_Genero']*80/100;
	...
	function ponerCuadroPaz()
	{
		...
		$this->SetXY(52,$yBarraPuntaje3-.5);
		$this->MultiCell(60, 5, utf8_decode("Fomentos de intercambios culturales") , 0, "R", false);
		$this->SetXY(52,$yBarraPuntaje4-.5);
		...
		$porcentajePatrimonioCultural=$this->arrDatos['tema_Proteccion_del_patrimonio_cultural_tangible_e_intangible']*80/100;
		...
		$this->Rect($xBarraPuntaje1, $yBarraPuntaje3, $porcentajeIntercambios, 4 ,"DF");
		$this->Rect($xBarraPuntaje1, $yBarraPuntaje4, $porcentajeCorrupcion, 4 ,"DF");
		$this->Rect($xBarraPuntaje1, $yBarraPuntaje5, $porcentajeEtica, 4 ,"DF");
		$this->Rect($xBarraPuntaje1, $yBarraPuntaje6, $porcentajePaz, 4 ,"DF");
	...
	function ponerCuadroProsperidad()
	{
		...
		$porcentajeEmpleo=$this->arrDatos['tema_Empleo_general']*80/100;
	...
	function ponerCuadroPlaneta()
	{
		...
		$porcentajeDisenoDestino=$this->arrDatos['tema_Planeacion_y_diseno_del_destino_']*80/100;
